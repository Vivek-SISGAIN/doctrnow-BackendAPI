...
export const config = {
  ...
  services: {
    ...
    insurance: process.env.INSURANCE_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || 'http://localhost:3006',
    fhir: process.env.FHIR_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || 'http://localhost:3006',
    paymentInsurance: process.env.PAYMENT_INSURANCE_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || 'http://localhost:3006',
