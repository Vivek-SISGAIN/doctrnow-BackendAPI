export default () => ({
  ...
  PAYMENT_SERVICE_URL: process.env.PAYMENT_SERVICE_URL || process.env.PAYMENT_INSURANCE_SERVICE_URL || 'http://localhost:3006',
  INSURANCE_SERVICE_URL: process.env.INSURANCE_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || process.env.PAYMENT_INSURANCE_SERVICE_URL || 'http://localhost:3006',
  FHIR_SERVICE_URL: process.env.FHIR_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || process.env.PAYMENT_INSURANCE_SERVICE_URL || 'http://localhost:3006',
  PAYMENT_INSURANCE_SERVICE_URL: process.env.PAYMENT_INSURANCE_SERVICE_URL || process.env.PAYMENT_SERVICE_URL || 'http://localhost:3006',
